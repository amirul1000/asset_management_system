        ...
        <td>
                        <table cellpadding="3" cellspacing="3" border="0" width="100%"  class="bodytext">
                            <tr>
                                <td>
                                    <!-- -->
                                    <form  name="report_fixed_asset_schedule_summary_frm" id="report_fixed_asset_schedule_summary_frm" method="post" action="" onsubmit=" return checkRequired();">
                                      <table>
									     <tr>
 											 <td>Asset at</td>
											 <td>
										 ...
										 <tr>
										 <td></td><td>
                                        <input type="hidden" name="cmd" id="cmd" value="make_report_fixed_asset_schedule_summary">
