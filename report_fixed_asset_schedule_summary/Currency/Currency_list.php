<?php
 ...
 <b>Location</b><br />
	  ...
	  <tr>
	   <td>  
			<a href="Currency.php?cmd=edit" class="nav3">Add a Currency</a>
			<table cellspacing="3" cellpadding="3" border="0" class="bodytext">
				<tr bgcolor="#CCCCCC">
				    <th>From country </th>
                    <th>From country currency </th>
                    <th>To country </th>
                    <th>To country currency </th>
			 ...
			 ?>
				<tr class="<?=$row?>" >
				  ...
				  <td>
					<?=$arr[$i]['to_country_currency']?>
				  </td>
					
				  <td nowrap >
					  <a href="Currency.php?cmd=edit&id=<?=$arr[$i]['id']?>" class="nav">Edit</a> |
					  <a href="Currency.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="nav" onClick=" return confirm('Are you sure to delete this item ?');">Delete</a>
				 </td>
