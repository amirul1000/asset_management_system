<?php
 ...
 <b>Company</b><br />
	  ...
	  <tr>
	   <td>  
			<a href="company.php?cmd=edit" class="nav3">Add Company</a>
			<table cellspacing="3" cellpadding="3" border="0" class="bodytext">
			 ...
			 <?php
					...
					$info["table"] = "company left outer join country on(company.Country=country.id)";
					$info["fields"] = array("company.*,country.name"); 
			 ...
			 ?>
				<tr class="<?=$row?>" >
				  ...
				  <td nowrap >
					  <a href="company.php?cmd=edit&id=<?=$arr[$i]['id']?>" class="nav">Edit</a> |
					  <a href="company.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="nav" onClick=" return confirm('Are you sure to delete this item ?');">Delete</a> 
				 </td>
