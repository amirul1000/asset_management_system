<?php
 ...
 ?>
  <b>Project</b><br />
                  ...
                  <form name="search_frm" id="search_frm" method="post">
                    <table width="60%" border="0"  cellpadding="2" cellspacing="1" class="bodytext">
                      ...
                      <TR>
                        ...
                        <td nowrap="nowrap" align="right">
                          <input type="hidden" name="cmd" id="cmd" value="search_Proj" >
	  ...
	  <tr>
	   <td>  
			<a href="Proj.php?cmd=edit" class="nav3">Add a Proj</a>
			<table cellspacing="3" cellpadding="3" border="0" class="bodytext">
			 ...
			 <?php
					...
					$info["table"] = "proj left outer join company on(proj.ComID=company.id)";
					$info["fields"] = array("proj.*","company.ComName"); 
			 ...
			 ?>
				<tr class="<?=$row?>" >
				  ...
				  <td nowrap >
					  <a href="Proj.php?cmd=edit&id=<?=$arr[$i]['id']?>" class="nav">Edit</a> |
					  <a href="Proj.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="nav" onClick=" return confirm('Are you sure to delete this item ?');">Delete</a> 
				 </td>
