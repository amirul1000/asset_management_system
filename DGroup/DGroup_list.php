<?php
 ...
 ?>
  <b>Default Group</b><br />
                  ...
                  <form name="search_frm" id="search_frm" method="post">
                    <table width="60%" border="0"  cellpadding="2" cellspacing="1" class="bodytext">
                      ...
                      <TR>
                        ...
                        <TD  nowrap="nowrap">
                          <?php
                          $hash    =  getTableFieldsName("dgroup");
                        ...
                        <td nowrap="nowrap" align="right">
                          <input type="hidden" name="cmd" id="cmd" value="search_DGroup" >
	  ...
	  <tr>
	   <td>  
			<a href="DGroup.php?cmd=edit" class="nav3">Add a DGroup</a>
			<table cellspacing="3" cellpadding="3" border="0" class="bodytext">
			 ...
			 <?php
					...
					$info["table"] = "dgroup left outer join company on(dgroup.ComID=company.id)";
					$info["fields"] = array("dgroup.*","company.ComName"); 
			 ...
			 ?>
				<tr class="<?=$row?>" >
				  ...
				  <td nowrap >
					  <a href="DGroup.php?cmd=edit&id=<?=$arr[$i]['id']?>" class="nav">Edit</a> |
					  <a href="DGroup.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="nav" onClick=" return confirm('Are you sure to delete this item ?');">Delete</a> 
				 </td>
