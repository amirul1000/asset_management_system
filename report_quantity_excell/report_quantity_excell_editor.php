        ...
        <td>
                        <table cellpadding="3" cellspacing="3" border="0" width="100%"  class="bodytext">
                            <tr>
                                <td>
                                    <!-- -->
                                    <form  name="report_quantity_excell_frm" id="report_quantity_excell_frm" method="post" action="" onsubmit=" return checkRequired();">
                                      <table>
									    <tr>
 											 <td>Date From</td>
											 <td>
										 ...
										 <tr>
										   ...
										   <table cellspacing="3" cellpadding="3" border="0" class="bdr" width="100%">
											<tr>
												...
												<td >
												   <input type="radio" name="option1" id="option1"  value="ACode" class="textbox" />Asset Code Wise<br />
												  <input type="radio" name="option1" id="option1"  value="SubGroup" class="textbox" checked="checked" /> Asset SubGroup Wise<br />
												   <input type="radio" name="option1" id="option1"  value="DefGroup" class="textbox" />Asset Group Wise<br />
										 ...
										 <tr>
										 <td></td><td>
                                        <input type="hidden" name="cmd" id="cmd" value="make_report_quantity_excell">
