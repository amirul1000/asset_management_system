...
<input type="hidden" name="closingdate" id="closingdate" value="<?=$_SESSION["clDate"]?>">
 ...
 <b> Fixed Asset Statement with Depreciation</b><br />
        ...
        <td>
                        <table cellpadding="3" cellspacing="3" border="0" width="100%"  class="bodytext">
                            <tr>
                                <td>
                                    <!-- -->
                                    <form  name="report_fixed_asset_schedule_dispose_summary_frm" id="report_fixed_asset_schedule_dispose_summary_frm" method="post" action="" onsubmit=" return checkRequired();">
                                      <table>
									     <tr>
 											 <td>Asset at</td>
											 <td>
										 ...
										 <tr>
										   ...
										   <table cellspacing="3" cellpadding="3" border="0" class="bdr" width="100%">
											<tr>
												...
												<td >
												   <input type="radio" name="option" id="option"  value="DefGroup" class="textbox"checked="checked"  />Asset Group Wise Summary<br />
												</td>
											</tr>
											</table>
											</td>
										  ...
										  <tr>
											 ...
											 <td>
													...
													$res  =  $db->select($info);
														...
														{
														?>
														<option value="<?=$each['id']?>"><?=$each['alias_name']?></option>
														<?php
														}
                                                        ?>
                                                    </select>
										 ...
										 <tr>
										 <td></td><td>
                                        <input type="hidden" name="cmd" id="cmd" value="make_report_fixed_asset_schedule_dispose_summary">
