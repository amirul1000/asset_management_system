        ...
        <td>
                        <table cellpadding="3" cellspacing="3" border="0" width="100%"  class="bodytext">
                            <tr>
                                <td>
                                    <!-- -->
                                    <form  name="report_fixed_asset_schedule_frm" id="report_fixed_asset_schedule_frm" method="post" action="" onsubmit=" return checkRequired();">
                                      <table>
									     <tr>
 											 <td>Asset at</td>
											 <td>
										 ...
										 <tr>
										   ...
										   <table cellspacing="3" cellpadding="3" border="0" class="bdr" width="100%">
											<tr>
												...
												<td >
												   <input type="radio" name="option" id="option"  value="ACode" class="textbox" checked="checked"/>Asset Code Wise<br />
										 ...
										 <tr>
										 <td></td><td>
                                        <input type="hidden" name="cmd" id="cmd" value="make_report_fixed_asset_schedule">
